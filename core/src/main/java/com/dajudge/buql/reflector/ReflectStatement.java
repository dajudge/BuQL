...
public abstract class ReflectStatement<Q, I, R> extends ReflectDatabaseOperation<Q, I, R> {

    protected ReflectStatement(
    ...
    protected void executeQuery(
        ...
        engine.executeStatement(sql, queryParameters, currentCallback);
    }
}
